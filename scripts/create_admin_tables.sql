...
-- Insertar configuraciones iniciales del bot
...
-- La contraseña debe ser hasheada en la aplicación, este es solo un placeholder
INSERT INTO admin_users (username, email, password_hash) VALUES
    ('admin', 'admin@elcorteelectrico.com', '$2b$12$LQiD4YwjHMz8N5bGKJvYaOc9QF2tGbHcZQ6RtPCMr2kv3tK.9oMH.')
...
SELECT 
    ...
    AVG(satisfaction_avg) as daily_satisfaction,
    (array_agg(popular_topics ORDER BY id DESC))[1] as topics
FROM conversation_metrics
GROUP BY date, platform
ORDER BY date DESC;

-- Vista para actividad reciente de admins
...
COMMENT ON TABLE bot_settings IS 'Configuraciones del chatbot almacenadas como clave-valor JSON';
COMMENT ON TABLE conversation_metrics IS 'Métricas agregadas de conversaciones para analytics';
COMMENT ON TABLE admin_activity_logs IS 'Registro de todas las acciones realizadas por administradores';
COMMENT ON TABLE admin_sessions IS 'Sesiones activas de administradores con tokens JWT';